...
class TopAssemblyReport extends StatelessWidget {
  const TopAssemblyReport({Key? key}) : super(key: key);
  ...
  Widget mobile(context) {
    ...
    return SafeArea(
      child: Scaffold(
          ...
          //                   child: Text('Top ${value1.topAssemblyList.length} Assembly',style: wardAppbarTxt),
          //                 );
          //               }
          //             ),
          //
              ...
              children: [
                Consumer<HomeProvider>(builder: (context, value, child) {
                  return ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount: value.topAssemblyList.length,
                      // itemCount:15,
                      itemBuilder: (BuildContext context, int index) {
                        List<Color> border = [];
                        border = homeProvider.getcolors(index);
                        var item = value.topAssemblyList[index];
                        return InkWell(
                          onTap: (){
