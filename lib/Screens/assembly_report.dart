...
class AssemblyReport extends StatelessWidget {
  String from;
   AssemblyReport({Key? key,required this.from}) : super(key: key);
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text('Assembly Reports',style: wardAppbarTxt),
                      ),
              ...
              children: [
                Consumer<HomeProvider>(builder: (context, value, child) {
                  return ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount: value.assemblyWiseReportList.length,
                      itemBuilder: (BuildContext context, int index) {
                        List<Color> border = [];
                        border = homeProvider.getcolors(index);
                        var item = value.assemblyWiseReportList[index];
                        return InkWell(
                          onTap: (){
                            ...
                            child: Container(
                              ...
                              child: ListTile(
                                leading: from=="ADMIN"?InkWell(
                                    ...
                                    child: value.refresheEchDistrict?const CircularProgressIndicator():const Icon(Icons.refresh)):Stack(
                                  children: [
                                    Container(
                                      decoration: const BoxDecoration(
                                ...
                                trailing: Container(
                                    ...
                                    child: Text( "₹" + getAmount(double.parse(item.assemblyAmount.toStringAsFixed(0))),
                                      style: const TextStyle(fontWeight: FontWeight.bold,fontSize: 16,color: cl323A71),)),
                              ),
                            ),
                          ),
                        );
