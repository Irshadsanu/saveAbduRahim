...
class PosterPageScreen extends StatelessWidget {
  num amount;
  String district;
  String panchayath;
  String ward;
  PosterPageScreen({Key? key, required this.amount, required this.district, required this.panchayath, required this.ward}) : super(key: key);
                    ...
                    child: Stack(
                      children: [
                        ...
                        SizedBox(
                          height: 420,
                          width: 340,
                          child: amount>=200000? Image.asset("assets/2LakhNew.jpg",fit: BoxFit.fill,alignment: Alignment.bottomCenter,):
                          amount>=100000?  Image.asset("assets/1lakh.jpg",fit: BoxFit.fill,alignment: Alignment.bottomCenter,):
                          const SizedBox(),
                        ),
                        Positioned(
                          top: district=="FAMILY CONTRIBUTION"?220:height*0.05,
                            left:width*0.12,
                              ...
                              children: [
                                ...
                                Container(
                                  // color: Colors.red,
                                    width: width*0.56,
                                    child: Text(ward,
                                      maxLines:2,overflow:TextOverflow.ellipsis,style:  TextStyle(fontSize:ward.length>20?10:16,
                                        fontWeight: FontWeight.bold, fontFamily: 'Montserrat',color:amount>=100000&& amount<=199999?
                                          cl6a776f:cl706a77),)
                                ),
                                ...
                                Container(
                                  ...
                                  height: 20,
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        panchayath=="FAMILY CONTRIBUTION"?SizedBox(): Container(
                                          alignment: Alignment.topLeft,
                                          width: width * .55,
                                            child: FittedBox(
                                              child: Text(panchayath,style:
                                              TextStyle(fontSize:panchayath.length>20? 11:12,fontWeight: FontWeight.w600,
                                                  fontFamily: 'Montserrat',color: amount>=100000&& amount<=199999?
                                                  cl6a776f:cl706a77),),
                                            )),
                                ...
                                //       crossAxisAlignment: CrossAxisAlignment.center,
                                //       children: [
                                //         district=="FAMILY CONTRIBUTION"?SizedBox(): Text(district,style:
                                //         TextStyle(fontSize: district.length>20?10:11,fontWeight: FontWeight.w600,
