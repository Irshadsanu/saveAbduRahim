...
class TopMuncipalityReport extends StatelessWidget {
  const TopMuncipalityReport({Key? key}) : super(key: key);
                      ...
                      Consumer<HomeProvider>(
                        builder: (context,value,child) {
                          return Padding(
                            ...
                            child: Text('Top ${value.topMuncipalityList.length} Municipality',style: wardAppbarTxt),
                          );
                        }
                      ),
              ...
              children: [
                Consumer<HomeProvider>(builder: (context, value, child) {
                  return ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount: value.topMuncipalityList.length,
                      itemBuilder: (BuildContext context, int index) {
                        List<Color> border = [];
                        border = homeProvider.getcolors(index);
                        var item = value.topMuncipalityList[index];
                        return InkWell(
                          onTap: (){
                            ...
                            child: Container(
                              ...
                              child: ListTile(
                                ...
                                trailing: Container(
                                    ...
                                    child: Text( "₹" + getAmount(double.parse(item.panchayathAmount.toStringAsFixed(0))),
