...
class QuotaCompletedScreen extends StatelessWidget {

  String district;
  String panchayath;
  String ward;
  QuotaCompletedScreen({Key? key, required this.district, required this.panchayath, required this.ward}) : super(key: key);
                    ...
                    child: Stack(
                      children: [
                        ...
                        SizedBox(
                          ...
                          width: 340,
                          child:
                          Image.asset("assets/QuataCompleted.jpg",fit: BoxFit.fill,alignment: Alignment.bottomCenter,)


                        ),
                        Positioned(
                            top: district=="FAMILY CONTRIBUTION"?220:height*0.045,
                            left: width*0.12,
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  // color: Colors.red,
                                    ...
                                    child: Text(ward,
                                      ...
                                      style:  TextStyle(fontSize:ward.length>20?15:17,fontWeight: FontWeight.bold, fontFamily: 'Montserrat',color: cl4c5a72),)
                                ),
                                          ...
                                          // color: Colors.yellowAccent,
                                            ...
                                            child: FittedBox(
                                              child: Text(panchayath,
                                                ...
                                                style:  TextStyle(fontSize:panchayath.length>20? 10:13,fontWeight: FontWeight.w600, fontFamily: 'Montserrat',color: cl4c5a72),),
                                            )),
                                ...
                                //       children: [
                                //         district=="FAMILY CONTRIBUTION"?SizedBox(): Text(district,style:  TextStyle(fontSize: district.length>20?10:11,fontWeight: FontWeight.w600, fontFamily: 'Montserrat',color: cl4c5a72),),
                                //
                                //       ],
                                //     ))
                              ],
